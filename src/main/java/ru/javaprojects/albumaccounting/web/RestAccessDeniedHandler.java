...
import static ru.javaprojects.albumaccounting.util.exception.ErrorType.ACCESS_DENIED_ERROR;
import static ru.javaprojects.albumaccounting.web.AppExceptionHandler.EXCEPTION_ACCESS_DENIED;
