...
public class DepartmentTestData {
    ...
    public static final Department department1 = new Department(DEPARTMENT_1_ID, "KTK-40");
    public static final Department department2 = new Department(DEPARTMENT_2_ID, "SKB-3");
    public static final Department department3 = new Department(DEPARTMENT_3_ID, "OTD 49/3");
